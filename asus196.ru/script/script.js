let arrayModel =  [['Телефон', 'Live'],['Телефон', 'PadFone E'],['Телефон', 'Padfone mini 4.3'],['Телефон', 'PadFone S'],['Телефон', 'ROG Phone'],['Телефон', 'Pegasus'],['Телефон', 'ZenFone 2'],['Телефон', 'ZenFone 2 Deluxe Special Edition'],['Телефон', 'ZenFone 2 Laser'],['Телефон', 'ZenFone 3'],['Телефон', 'ZenFone 3 AR'],['Телефон', 'ZenFone 3 Deluxe'],['Телефон', 'ZenFone 3 Deluxe (ZS550KL)'],['Телефон', 'ZenFone 3 Laser'],['Телефон', 'ZenFone 3 Max'],['Телефон', 'ZenFone 3 Max ZC553KL'],['Телефон', 'ZenFone 3 Ultra'],['Телефон', 'ZenFone 3 ZE520KL'],['Телефон', 'ZenFone 3 Zoom'],['Телефон', 'ZenFone 4'],['Телефон', 'ZenFone 4 (ZE554KL)'],['Телефон', 'ZenFone 4 Max'],['Телефон', 'ZenFone 4 Max ZC520KL'],['Телефон', 'ZenFone 4 Pro (ZS551KL)'],['Телефон', 'ZenFone 4 Selfie (ZD553KL)'],['Телефон', 'ZenFone 4 Selfie Pro (ZD552KL)'],['Телефон', 'ZenFone 5'],['Телефон', 'ZenFone 5 Lite'],['Телефон', 'ZenFone 5Z'],['Телефон', 'ZenFone 6'],['Телефон', 'ZenFone C'],['Телефон', 'ZenFone Go'],['Телефон', 'ZenFone Go ZB500KG'],['Телефон', 'Zenfone Live ZB501KL'],['Телефон', 'ZenFone Max'],['Телефон', 'Zenfone Max (M1) ZB555KL'],['Телефон', 'Zenfone Max M2'],['Телефон', 'Zenfone Max Plus (M1)'],['Телефон', 'Zenfone Max Pro (M2)'],['Телефон', 'ZenFone Max Pro M1'],['Телефон', 'ZenFone Selfie'],['Телефон', 'ZenFone Zoom'],];
...
$(document).ready( function () {
  ...
  function sendAjaxForm(url) {
      $.ajax({
          ...
          data: "name="+$("#firstNameId").val()+" "+$("#nameId").val()+" "+$("#lastNameId").val()+"&tel="+$("#telId").val()+"&nodeJob="+nodeJob_status+"&desp="+$("#descId").val()+"&type="+priceDevice_check+"&brand=Asus&model="+priceModel_check+"&service="+$("#service_title").text()+"&priceService="+price_check,  // Сеарилизуем объект
  ...
  function sendAjaxFormConsult(url, name, tel) {
      $.ajax({
          ...
          type:     "POST", //метод отправки
          dataType: "html", //формат данных
          data: "name="+name+"&tel="+tel+"&brand=Asus&nodeJob="+nodeJob_status,  // Сеарилизуем объект
 ...
 function someFunction(data) {
  ...
  arrayModel.forEach((item, i) => {
    $('.modelMainContent section').append('<div class="modelBox"><span class="titleModelBox">'+item[1]+'</span>'+'<img src="img/Asus/asus/'+item[1].trim().toLowerCase().replace(/[^a-zA-Z0-9 -]/, "").replace(/\s/g, "-")+'.png" class="img_modelBox"></div>');
  });
